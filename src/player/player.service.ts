...
import { CreateAutoGenPlayerInterface } from './interfaces/create-auto-gen-player.interface';
...
export class PlayerService {
  ...
  async addAutoGeneratedPlayer(createAutoGenPlayer: CreateAutoGenPlayerInterface): Promise<Player> {
    let team: Team = null;
